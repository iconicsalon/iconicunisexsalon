					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						<div className="lg:col-span-1">
							...
							<p className="text-gray-300 mb-6 leading-relaxed">
								Transform your look with our premium beauty and wellness
								services in the heart of Bengaluru.
							</p>
							<div className="flex space-x-4">
								...
								<Button
									size="sm"
									variant="outline"
									className="border-salon-gold text-salon-gold hover:bg-salon-gold hover:text-white"
								>
								...
								<Button
									size="sm"
									variant="outline"
									className="border-salon-rose text-salon-rose hover:bg-salon-rose hover:text-white"
								>
						...
						{/* Services */}
						<div>
							<h4 className="text-lg font-semibold mb-4 text-salon-gold">
								Our Services
							</h4>
							<ul className="space-y-2">
								{services.map((service) => (
									<li key={service}>
										<a
											href="#"
											className="text-gray-300 hover:text-salon-purple transition-colors text-sm"
										>
											{service}
										</a>
									</li>
				...
				<div className="border-t border-gray-700">
					<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
						<div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
							<div>© 2024 Royal Glow Salon & Spa. All rights reserved.</div>
							<div className="flex space-x-6 mt-4 md:mt-0">
								<a
									href="#"
									className="hover:text-salon-purple transition-colors"
								>
									Privacy Policy
								</a>
								<a
